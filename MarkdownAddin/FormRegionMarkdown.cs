...
namespace MarkdownAddin
{
    partial class FormRegionMarkdown
    {
        ...
        public partial class FormRegionMarkdownFactory
        {
            ...
            private void FormRegionMarkdownFactory_FormRegionInitializing(object sender,
        ...
        private void FormRegionMarkdown_Leave(object sender, EventArgs e)
        {
        }

        private void FormRegionMarkdown_VisibleChanged(object sender, EventArgs e)
        {
        }

        private void FormRegionMarkdown_RegionChanged(object sender, EventArgs e)
        {
        }
